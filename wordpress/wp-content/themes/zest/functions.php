...
class SJDSite extends Timber\Site {
	...
	public function register_post_types() {
		SJDSite::create_post_type('project', 'Project', 'Projects', 'our-work');
	}
	...
	public function add_to_context( $context ) {
		...
		$context['contact_details'] = get_field('contact_details', 'option');
		$context['social_links'] = get_field('social_links', 'option');
		$context['footer'] = get_field('footer', 'option');

		$context['pillars'] = get_field('pillars', 'option');
		$context['pillars_intro'] = get_field('pillars_intro', get_option('page_on_front'));
		$context['pillars_link'] = get_field('pillars_link', get_option('page_on_front'));
...
if( function_exists('acf_add_options_page') ) {
	acf_add_options_page('Zest Settings');
	acf_add_options_page('Pillars');
}
